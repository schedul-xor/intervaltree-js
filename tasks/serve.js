/**
 * This task starts a dev server that provides a script loader for Murmur
 * hash and Closure Library.  In addition, a static server hosts all files in the
 * repository.
 */
...
/**
 * Create a debug server for itree and Closure Library sources.
